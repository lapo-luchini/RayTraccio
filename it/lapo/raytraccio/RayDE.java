...
// $Header: /usr/local/cvsroot/RayTraccio/it/lapo/raytraccio/RayDE.java,v 1.1 2004/12/16 23:09:56 lapo Exp $
 ...
 */
public class RayDE extends javax.swing.JApplet implements WindowListener,
    ...
    /**
     * connEtoC2: (Traccia.action.actionPerformed(java.awt.event.ActionEvent)
     * --> RayDE.traccia_ActionPerformed(Ljava.awt.event.ActionEvent;)V)
     * 
    ...
    private javax.swing.JEditorPane getEditorSDL() {
        if (ivjEditorSDL == null) {
            try {
                ...
                // user code begin {1}
                document = (javax.swing.text.PlainDocument) ivjEditorSDL
                        .getDocument();
                document.putProperty(PlainDocument.tabSizeAttribute,
                        new Integer(2));
                // user code end
            } catch (java.lang.Throwable ivjExc) {
                // user code begin {2}
    ...
    private javax.swing.JTabbedPane getLinguette() {
        if (ivjLinguette == null) {
            try {
                ...
                ivjLinguette.insertTab("SDL", null, getPanelSDL(),
                        "Qua puoi definire la scena in linguaggio SDL.", 0);
                ivjLinguette.insertTab("Albero", null, getPanelTree(), null, 1);
                ivjLinguette.insertTab("Immagine", null, getPanelImage(),
                        "Qua appare l\'immagine creata.", 2);
    ...
    private javax.swing.JPanel getPanelAbout() {
        if (ivjPanelAbout == null) {
            try {
                ...
                constraintsLabelAbout1.gridx = 0;
                constraintsLabelAbout1.gridy = 0;
                ...
                constraintsLabelAbout2.gridx = 0;
                constraintsLabelAbout2.gridy = 1;
                ...
                constraintsLabelAbout3.gridx = 0;
                constraintsLabelAbout3.gridy = 2;
                ...
                constraintsLabelAbout4.gridx = 0;
                constraintsLabelAbout4.gridy = 3;
    ...
    private javax.swing.JPanel getPanelStats() {
        if (ivjPanelStats == null) {
            try {
                ...
                getPanelStats().add(getProgressBar(),
                        getProgressBar().getName());
                // user code begin {1}
                // user code end
            } catch (java.lang.Throwable ivjExc) {
                // user code begin {2}
    ...
    private javax.swing.JProgressBar getProgressBar() {
        if (ivjProgressBar == null) {
            try {
                ...
                ivjProgressBar
                        .setToolTipText("Percentuale dell\'immagine creata.");
        ...
        if (ivjScrollaImmagine == null) {
            try {
                ...
                if (ivjRayTracerComponent == null) { // vallo a capire!
                    ...
                    getScrollaImmagine().setViewportView(
                            getRayTracerComponent());
                }
                // user code end
            } catch (java.lang.Throwable ivjExc) {
                // user code begin {2}
    ...
    /**
     * Paints the applet. If the applet does not need to be painted (e.g. if it
     * is only a container for other awt components) then this method can be
     * safely removed.
     * 
    ...
    public void run() {
        while (true) {
            if ((time_mod > time_parse)
                    && (System.currentTimeMillis() > time_mod + 3000)) {
                time_parse = System.currentTimeMillis();
                try {
                    if (parser == null)
                        parser = new SDL(new java.io.StringReader(
                                getEditorSDL().getText()));
                    else {
                        parser.cons.clear();
                        parser.ReInit(new java.io.StringReader(getEditorSDL()
                                .getText()));
                    }
                    scene = parser.sdlScene();
                    getParserError().setText(
                            "Scene succesfully parsed in "
                                    + (System.currentTimeMillis() - time_parse)
                                    + " ms.");
                } catch (Throwable e) {
                    scene = null;
    ...
    public void traccia_ActionPerformed(java.awt.event.ActionEvent actionEvent) {
        ...
        rt.init(scene, 1, new Dimension(Integer.parseInt(getDimX().getText()),
                Integer.parseInt(getDimY().getText())), 1, getCheckBoxAA()
                .isSelected());
        rt.start();
